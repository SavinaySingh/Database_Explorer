...
class TestSetNegatives(unittest.TestCase):
    ...
    def test_n_zeros_with_init(self):
        ...
        sql=get_negative_number_query(numeric2.db.database,numeric2.table_name,numeric2.col_name)
...
class TestSetStd(unittest.TestCase):
    ...
    def test_col_std_with_init(self):
        ...
        numeric2.set_data()
        numeric2.set_std()
        sql=get_std_query(numeric2.db.database,numeric2.table_name,numeric2.col_name)
...
class TestGetSummaryDataframe(unittest.TestCase):
    def test_get_summary_without_init(self):
        numeric=NumericColumn(table_name='order_details',col_name='discount')
        ...
        self.assertEqual(numeric.get_summary_df(),dict_test,'Incorrect')
 
    def test_get_summary_with_init(self):
        numeric=NumericColumn(table_name='order_details',col_name='discount')
        numeric.set_data()
        numeric.set_unique()
        numeric.set_missing()
